...
public class LowResolutionCamera : MonoBehaviour
{
    ...
    public void SetResolution(float resolutionWeight)
    {
        ...
        _renderTexture = new RenderTexture(
            width: (int)(Screen.width * _currentResolutionWeight),
            height: (int)(Screen.height * _currentResolutionWeight),
            depth: 24
        );
        ...
        //Debug.Log(BuiltinRenderTextureType.CameraTarget);

        //renderTextureをtargetとする
